...
public class QueryBrowserActivity extends nookListActivity implements MusicUtils.Defs
{
    ...
    {
    	NAME = "nookMedia: Query Browser";
    }

    @Override
    public boolean onKeyDown(int keyCode, KeyEvent evnt) {
        boolean handled = false;
    	int pos = this.mQueryCursor.getPosition();
    	if(pos == this.mQueryCursor.getCount()) {
    		pos = -1;
    	}
    	KeyEvent event;
