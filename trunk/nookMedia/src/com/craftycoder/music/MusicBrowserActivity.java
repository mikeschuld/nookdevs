...
public class MusicBrowserActivity extends nookBaseActivity
    ...
    public void init() {
        ...
        b = (View) findViewById(R.id.party_shuffle_holder);
        b.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.nowplaying:
                ...
                startActivity(intent);
                break;
            case R.id.party_shuffle_holder:
				int shuffle;
				try {
