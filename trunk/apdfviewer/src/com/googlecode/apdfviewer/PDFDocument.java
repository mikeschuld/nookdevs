...
public class PDFDocument {
    ...
    // public PDFDocument(String fileName, String ownerPassword, String
    // userPassword) {
    ...
    public native void drawPageSlice(Canvas canvas, int page, int sliceX, int sliceY, int sliceW, int sliceH);
