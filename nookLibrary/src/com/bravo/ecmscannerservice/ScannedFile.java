...
public class ScannedFile implements Parcelable , Comparable, Serializable {
	...
	public static final Parcelable.Creator<ScannedFile> CREATOR = 
		new Parcelable.Creator<ScannedFile>() {
	...
	public int compareTo(Object arg0) {
		if( arg0 instanceof ScannedFile) {
				...
				switch( m_SortType) {
					...
					case SORT_BY_LATEST:
						if( getLastAccessedDate() == null) {
							...
							int ret=this.getLastAccessedDate().compareTo( file1.getLastAccessedDate());
							if( ret ==0) {
								return getTitle().compareToIgnoreCase(file1.getTitle());
							} else {
								return -ret;
			...
			if( file1.pathname != null) {
				return file1.pathname.compareTo(pathname);
			}
		}
		return -1;
	}
	...
	public String toString() {
		...
		str.append("published date =" + this.publishedDate+"\n");
		str.append("last accessed date=" + this.lastAccessedDate+"\n");
		str.append("created date=" + this.createdDate+"\n");
		str.append("titles =" + this.titles+"\n");
		str.append("contributors  =" + this.contributors+"\n");
