...
public class TrackBrowserActivity extends nookListActivity
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection, GreyBarTouchInterface
{
    ...
    public boolean onKeyDown(int keyCode, KeyEvent evnt) {
        ...
        if(pos == -1)
        	newList = true;
    	int pos = this.mTrackCursor.getPosition();
    	KeyEvent event;
    	Log.d(LOGTAG,"Current Position " + pos + " "+ this.mTrackCursor.getCount());
        switch (keyCode) {
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        if(mi != null) {
        	...
        	mSelectedPosition = mTrackCursor.getPosition();
        }
        try {
        	...
        	if(mi != null) {
        		...
        		mSelectedId = mTrackCursor.getInt(mTrackCursor.getColumnIndexOrThrow(MediaStore.Audio.Media._ID));
        	}
        }
        ...
        Log.d(LOGTAG,"mCurrentAlbumName:"+mCurrentAlbumName);
        Log.d(LOGTAG,"mCurrentArtistNameForAlbum:"+mCurrentArtistNameForAlbum);
        Log.d(LOGTAG,"mCurrentTrackName:"+mCurrentTrackName);
    }
